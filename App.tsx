            ...
            <div className="flex flex-col lg:flex-row gap-5 items-stretch lg:items-center">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button 
                  ...
                  className={`relative flex items-center gap-3 py-3 px-6 rounded-xl font-black text-[11px] uppercase tracking-widest transition-all border-b-4 active:translate-y-0.5 active:border-b-0 shadow-lg ${
